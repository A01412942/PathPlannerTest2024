...
public class RobotContainer {
  ...
  private final JoystickButton indexer = new JoystickButton(xbox, XboxController.Button.kX.value); 
  private final JoystickButton shooter = new JoystickButton(xbox, XboxController.Button.kY.value);
